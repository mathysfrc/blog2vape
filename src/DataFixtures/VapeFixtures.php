...
class VapeFixtures extends Fixture
{
    public const VAPE = [
        [
            ...
            'category' => 'category_smoke',
            'link' => 'https://www.lepetitvapoteur.com/fr/blog/test-du-kit-pico-s-de-eleaf-et-du-clearomiseur-ello-vate-n418'
        ],
    ...
    public function load(ObjectManager $manager): void
    {
        foreach (self::VAPE as $vaper){
            ...
            $vape->setCategory($this->getReference($vaper['category']));
